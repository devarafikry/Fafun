...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!haveNetworkConnection()){
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage("Periksa Koneksi Internet Anda")
                    .setCancelable(false)
...
//        });
        ...
        Button nEmailLogInButton = (Button) findViewById(R.id.email_sign_in_button);
        nEmailLogInButton.setOnClickListener(new OnClickListener() {
            @Override
